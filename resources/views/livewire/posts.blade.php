<div>
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 mt-10">
        ...
        <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
            ...
            @if(session()->has('info'))
            <div class="bg-blue-400 border-2 border-blue-600 rounded-b mb-2 py-1">
                <div>
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                ...
                                                <div class="text-sm text-gray-900">{{ $post ->description }}
                                            ...
                                            <td class="px-6 block py-4 whitespace-nowrap text-sm text-gray-500">
                                                <button wire:click="edit({{ $post ->id }})" class="bg-yellow-500 hover:bg-yellow-500 text-white font-bold p-2 px-4 rounded ">
                                                    Edit
                                                </button>
